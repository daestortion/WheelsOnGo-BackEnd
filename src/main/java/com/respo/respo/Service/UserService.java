...
import com.respo.respo.Configuration.TokenGenerator;
...
public class UserService {
    ...
    public UserEntity insertUser(UserEntity user) throws IllegalArgumentException {
        ...
        logService.logActivity("User " + savedUser.getUsername() + " has registered to WheelsOnGo.",
    ...
    public int loginUser(String identifier, String password) {
        Optional<UserEntity> userOpt = identifier.contains("@") ? urepo.findByEmail(identifier)
